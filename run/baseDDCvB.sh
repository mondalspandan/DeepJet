...
source gpu_env.sh
cd Train
convertFromRoot.py -i ../list_80x_train.txt -o $INDIR/dctrain -c TrainData_DeepDoubleCvB_reference
...
python Eval.py -i $INDIR/dctest/dataCollection.dc -t $INDIR/dctrain/dataCollection.dc -d $INDIR/training_nodec -o $INDIR/res --taggerName "CvB"
python Eval.py -i $INDIR/dctest/dataCollection.dc -t $INDIR/dctrain/dataCollection.dc -d $INDIR/training -o $INDIR/res_dec --taggerName "CvBdec"
