...
#SBATCH --job-name  DeepJetBoostDDCvB
...
INDIR=~/data/boost/DDCvBfull100
#rm -r $INDIR
#mkdir $INDIR   
cd ~/data/Mauro/DeepJet
source gpu_env.sh
cd Train
#convertFromRoot.py -i ../HccHbb_train_list.txt -o $INDIR/dctrain -c TrainData_deepDoubleCvB_lowest
