...
INDIR=/beegfs/desy/user/spmondal/DNN/181104_adv_94x50p_CvB
rm -r $INDIR
mkdir $INDIR   
cd /home/spmondal/DNN_test/DeepJet_94xadv
source gpu_env.sh
cd Train
convertFromRoot.py -i ../train_list_94x_50p.txt -o $INDIR/dctrain -c TrainData_DeepDoubleCvB_reference
