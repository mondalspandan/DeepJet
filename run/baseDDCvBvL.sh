...
#SBATCH --workdir   /home/spmondal/DNN2/DeepJet/run
#SBATCH --job-name  DDC
...
INDIR=/beegfs/desy/user/spmondal/DNN/181023_94X
rm -r $INDIR
mkdir $INDIR   
cd /home/spmondal/DNN2/DeepJet
source gpu_env.sh
cd Train
convertFromRoot.py -i ../train_list_94x.txt -o $INDIR/dctrain -c TrainData_DeepDoubleX_3lab
python Train.py -i $INDIR/dctrain/dataCollection.dc -o $INDIR/training --batch 4096 --epochs 100 --resume -m
cp -r $INDIR/training $INDIR/training_nodec
python Train.py -i $INDIR/dctrain/dataCollection.dc -o $INDIR/training --batch 4096 --epochs 20 --resume --decor --classes 3 -m

convertFromRoot.py -i ../test_list_94x.txt -o $INDIR/dctest --testdatafor $INDIR/training/trainsamples.dc
